...
public class UDPPacketServer {
    ...
    public static void main(String[] args) {
        ...
        try (DatagramSocket serverSocket = new DatagramSocket(PORT)) {
            ...
            sandDataToClient(audioFileName, serverSocket, clientPacket);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    private static void sandDataToClient(String audioFileName, DatagramSocket serverSocket,
                                         DatagramPacket clientPacket) {
        ByteBuffer buffer = ByteBuffer.allocate(PACKET_SIZE);

        try (FileChannel fileChannel = FileChannel.open(Paths.get(audioFileName),
